...
<html lang="en">
    ...
    <body class="b">
        ...
        <h3 class="center-align white-text">Audio Search Results</h3>
        <br>
        <div class="center">
        <input type="file" id="rll" /><audio id="rllly" controls><source src="" id="rlly" /></audio>
        <a href="#" class="btn indigo darken-2">Add to Cart</a>
        </div>
        <br>
        <br>
            <div class ="center"><button onclick="audio_check()" class="waves-effect waves-light btn-small indigo right-align">Check for Item</button></div>
            <br>
        {{-- <button type="button" onclick="document.getElementById("rllly").play()">Play</button> --}}
                    ...
                    {{-- @foreach ($products as $products)
                            <div class="card" style="width: 23.5rem;">
                                <div class="card-image">
                                    <img src="{{$products->image}}" alt="" width='200px' height='200px'>
                                </div>
                                <div class="card-content">
                                    <span class="card-title bold">{{$products->name}}</span>
                                    <p><strong>Price:</strong> ${{$products->cost}}</p>
                                    <p><audio controls><source src="{{$products->audio}}" type="audio/mpeg"></audio></p>
                                </div>
